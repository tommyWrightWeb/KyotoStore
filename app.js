...
$(function () { $(document).scroll(function () { var $nav = $(".navbar"); $nav.toggleClass('scrolled', $(this).scrollTop() > $nav.height()); }); });
...
function displaycart() {
   ...
   if (cartItems && productContainer) {
      ...
      Object.values(cartItems).map(item => {
         ...
         <span class class= "name"> ${item.name.substring(0, 20)} </span> 
